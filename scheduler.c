        ...
        if (running_proc != NULL) {
            ...
            // I/O를 수행해야 하는 경우 (Running -> Waiting)
                ...
                if (executed_cpu % running_proc->io_interval == 0) {
                    running_proc->current_io_burst = running_proc->remaining_io / running_proc->remaining_io_count;
                    running_proc->remaining_io -= running_proc->current_io_burst;
